...
public class IfStmtProcess {
	
	public void process(IfStmt n, ChangedFile changedFile, Map<Integer, String> changedFilePatchWLines, Map<String, String> repositoryJavaFiles) {
		...
		for(int key : changedFilePatchWLines.keySet()) {
			try {
				...
				//System.out.println("Problem on line: " + changedFilePatch.get(i) + "\t ---- cause is: " + e.getLocalizedMessage());
				continue;
			}
